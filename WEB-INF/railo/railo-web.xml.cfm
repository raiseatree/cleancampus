<?xml version="1.0" encoding="UTF-8"?><railo-configuration password="4d187b1c7f122c0f9812f2c415b1b74f8d5f558ab4058f5e7adc7c06d6f5852a" version="2.0">
  <cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<!--
	 ...
	 -->
	<debugging debug="false" show-query-usage="false" template="/railo-context/templates/debugging/debugging.cfm"/>
...
<extensions><extension author="Paul Klinkenberg" category="Debugging" codename="" config="{'MIXED':{'SAVEPATH':'/Users/andy/Sites/Cows/cleancampus/WEB-INF/railo/context/admin/plugin/Log analyzer/'},'STEPS':[]}" created="{ts '2010-12-16 00:18:32'}" description="&#10;&#9;This extension adds a plugin to your Railo server/web admin, to view the Railo log files." documentation="" forum="" id="1C9A7C34-2555-4AAA-92FBB7FC7111140C" image="http://www.getrailo.org/tasks/sites/railoorg/cache/file/05D40A41-ACE5-4667-BECDD4F5EE7A6CF6_medium.png" label="Log analyzer" mailinglist="" name="log-analyzer" network="" provider="http://www.getrailo.org/ExtensionProvider.cfc" support="http://www.railodeveloper.com/post.cfm/railo-admin-log-analyzer" type="web" version="2.1.1" video=""/></extensions></railo-configuration>